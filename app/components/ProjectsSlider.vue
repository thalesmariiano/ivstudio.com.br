...
<template>
    <div class="w-full py-16 bg-gradient-to-t from-black from-70%">
        <div class="w-full max-w-4xl flex gap-y-5 justify-center sm:justify-between items-center px-3 mx-auto mb-10">
            <p class="font-poppins font-medium text-white italic">
                <span class="text-neutral-500">//</span>
                Confira alguns projetos
            </p>
            <NuxtLink to="/portfolio" class="hidden sm:flex gap-2 items-center text-white font-poppins font-light italic hover:underline">
                Veja mais projetos
        ...
        <NuxtLink to="/portfolio" class="w-fit flex sm:hidden gap-2 items-center text-white font-poppins font-light italic hover:underline mx-auto">
            Veja mais projetos
            <IconsArrowForward width="18" height="18" stroke="#fff" />
        </NuxtLink to="/portfolio">
    </div>
