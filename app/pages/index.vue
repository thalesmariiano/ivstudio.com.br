<script setup lang="ts">
    useSeoMeta({
        ...
        description: 'Criamos sites que fazem seu negócio vender mais. Do design à estrategia, tudo é pensado para atrair clientes e gerar conversões. Simples, bonito e eficiente - exatamente como seu site deve ser.',
...
<template>
    ...
    <video class="w-full h-screen overflow-x-hidden object-cover absolute top-0 left-0 -z-5" poster="@/assets/images/start-bg.png" autoplay muted loop playsinline webkit-playsinline disablepictureinpicture preload="auto">
